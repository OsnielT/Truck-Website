						...
						if( strpos($whatIWant, $searchString) !== false ) {
							...
							if (is_array($carimg)) {
								...
								foreach($carimg as $key => $value){
									...
									echo "<img width='100%' class='" . $active . "'  height='auto' src='../admin/pictures/".$value."'> "; 
									if($count == '1'){ echo "<img width='100%' class='nonactive'  height='auto' src='../admin/pictures/".$value."'> ";  $active = "active";}
								}
						 	...
						 	$whatIWant = $row['image'];
						 	echo "<img width='100%' height='auto' src='../admin/pictures/".$whatIWant."'> "; 
						 }
